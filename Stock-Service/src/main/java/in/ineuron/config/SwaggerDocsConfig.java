...
public class SwaggerDocsConfig {
	...
	public Docket createDocket() {
		return new Docket(DocumentationType.SWAGGER_2).// UI Screen type
				...
				.paths(PathSelectors.regex("/price.*")).// To specify the request paths
				build()// build the docket object
				.useDefaultResponseMessages(true).apiInfo(getApiInfo());
	}

	private ApiInfo getApiInfo() {
		Contact contact = new Contact("Shivam", "http://www.ineuron.ai/course", "dubeyshivam437@gmail.com");
		return new ApiInfo("Stock-price ", "Gives information about price of stocks ", "3.4.RELEASE", "http:", contact,
